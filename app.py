    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        :root {
            ...
            --field-focus:  rgba(31,216,164,0.5);
        }
        ...
        .bg-mesh {
            ...
            background-image:
                radial-gradient(ellipse at 85% 5%,  rgba(31,216,164,0.18) 0%, transparent 50%),
                radial-gradient(ellipse at 10% 90%, rgba(255,255,255,0.06) 0%, transparent 45%),
        ...
        .input-wrap select {
            cursor: pointer;
            background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='rgba(255,255,255,0.4)' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e");
            background-repeat: no-repeat;
            background-position: right 12px center;
            background-size: 13px;
        }

        /* Fix select option colors for dark bg */
        ...
        .btn-signin {
            ...
            box-shadow: 0 4px 20px rgba(31,216,164,0.35);
        ...
        .btn-signin:hover {
            background: #25edb4;
            box-shadow: 0 6px 24px rgba(31,216,164,0.5);
            transform: translateY(-1px);
        }
        .btn-signin:active  { transform: translateY(0); box-shadow: 0 2px 10px rgba(31,216,164,0.3); }
        ...
        .spinner {
            ...
            border: 2.5px solid rgba(9,47,52,0.3);
        ...
        .footer-brand strong { color: rgba(255,255,255,0.45); }
        ...
        #overlay {
            ...
            gap: 16px; color: #fff; font-size: 15px; font-weight: 500;
        }
        ...
        <div class="brand-section">
            <div class="logo-mark">
                <svg viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20 4L8 19h9l-3 11 13-16h-9l2-10z" fill="white" stroke="rgba(255,255,255,0.3)" stroke-width="0.5"/>
                </svg>
            </div>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        :root {
            ...
            --field-bg:   rgba(255,255,255,0.10);
            --field-border:rgba(255,255,255,0.18);
            --field-focus: rgba(31,216,164,0.45);
        }
        ...
        .brand-section { text-align: center; padding-bottom: 32px; }
        .logo-mark {
            width: 68px; height: 68px;
            background: linear-gradient(145deg, rgba(255,255,255,0.18), rgba(255,255,255,0.06));
        ...
        .form-section { flex: 1; }
        .form-title   { font-size: 22px; font-weight: 700; color: #fff; margin-bottom: 3px; }
        .form-subtitle { font-size: 13.5px; color: rgba(255,255,255,0.5); margin-bottom: 26px; }
        .error-banner {
        ...
        .input-wrap input::placeholder { color: rgba(255,255,255,0.28); font-weight: 400; }
        .input-wrap select {
            cursor: pointer;
            background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='rgba(255,255,255,0.4)' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e");
            background-repeat: no-repeat; background-position: right 12px center; background-size: 13px;
        }
        .input-wrap select option { background: #0E4950; color: #fff; }
        .input-wrap input:focus, .input-wrap select:focus {
            border-color: var(--accent); background: rgba(255,255,255,0.13);
            box-shadow: 0 0 0 3px var(--field-focus);
        }
        .input-wrap:focus-within .pfx { color: var(--accent); }
        .phone-row { display: flex; gap: 10px; }
        ...
        .btn-primary {
            ...
            border: none; border-radius: 12px;
            font-size: 15.5px; font-weight: 700; font-family: inherit;
            cursor: pointer; background: var(--accent); color: var(--brand-dark);
            box-shadow: 0 4px 20px rgba(31,216,164,0.35);
            transition: background 0.15s, transform 0.1s, box-shadow 0.15s;
            position: relative; overflow: hidden;
        }
        ...
        .btn-primary:hover { background: #25edb4; box-shadow: 0 6px 24px rgba(31,216,164,0.5); transform: translateY(-1px); }
        ...
        .spinner {
            width: 16px; height: 16px;
            border: 2.5px solid rgba(9,47,52,0.3); border-top-color: var(--brand-dark);
        ...
        .sep::before, .sep::after { content: ''; flex: 1; height: 1px; background: rgba(255,255,255,0.12); }
        .footer { text-align: center; margin-top: 20px; }
        .switch-line { font-size: 14px; color: rgba(255,255,255,0.5); }
        ...
        .footer-links a { font-size: 11.5px; color: rgba(255,255,255,0.28); text-decoration: none; transition: color 0.15s; }
        .footer-links a:hover { color: var(--accent); }
        .footer-brand { margin-top: 18px; padding-top: 14px; border-top: 1px solid rgba(255,255,255,0.1); font-size: 11px; color: rgba(255,255,255,0.22); letter-spacing: 0.3px; }
        .footer-brand strong { color: rgba(255,255,255,0.42); }
        #overlay {
            display: none; position: fixed; inset: 0; background: var(--brand-dark);
    ...
    if request.method == "POST":
        ...
        try:
            ...
            try:
                ...
                c.execute("UPDATE users SET username=? WHERE phone=?", (display_name, phone))
                c.execute("UPDATE users SET display_name=? WHERE phone=? AND (display_name IS NULL OR display_name='')", (display_name, phone))
                conn.commit()
            finally:
                return_db_connection(conn)
...
def signin():
    if request.method == "POST":
        ...
        try:
            ...
            try:
                c = conn.cursor()
                # Sign in: only update last_online — don't change any profile data
                c.execute("INSERT OR IGNORE INTO users(phone,last_online) VALUES(?,?)", (phone, now_iso))
                c.execute("UPDATE users SET last_online=? WHERE phone=?", (now_iso, phone))
                conn.commit()
            finally:
